...
\agradecimentos{\input{Partes/Agradecimentos.tex}}

% Epígrafe (Opcional)
\epigrafe{\input{Partes/Epigrafe.tex}}

% Resumo (Obrigatório)
\resumo{\input{Partes/Resumo.tex}}

% Abstract (Obrigatório)
\abstract{\input{Partes/Abstract.tex}}
